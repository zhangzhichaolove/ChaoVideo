...
public class VideoListAdapter extends CommonAdapter<VideoType> {


    public VideoListAdapter(Context context, int layoutId, List<VideoType> datas) {
        super(context, layoutId, datas);
    }

    @Override
    protected void convert(ViewHolder holder, VideoType videoType, int position) {
        holder.setText(R.id.tv_title, videoType.title);
...
//        int height = data.getHeight()*width/data.getWidth();//计算View的高度
        ...
        ImageLoader.load(mContext, videoType.pic, iv);
    }
}
